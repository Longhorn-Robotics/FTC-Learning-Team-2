...
Top of the court is 0 deg, our goal isd at 45 deg in the top right corner, right of th ecour tis 90 deg, and so on and so forth.
...
1. Using the camera, the robot must make sure it is properly aligned with the AprilTag (it will already be facing that rough direction)
